function config_ops($stateProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider.state('hmgr', {
        ...
        url: "hmgr_archhost",
        data: {pageTitle: '主机归档'},
        templateUrl: "views/ops/hostmgrarch.html?v=" + version,
        resolve: {
            loadPlugin: function ($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    serie: true,
                    files: ['views/ops/hostmgrarch.js?v=' + version]
                }]);
            }
        }
    });
    ...
    }).state('infosys.sysmap', {
        url: "infosys_sysmap",
        data: {pageTitle: '系统主机映射'},
        templateUrl: "views/ops/syshostmap.html?v=" + version,
        resolve: {
            loadPlugin: function ($ocLazyLoad) {
                return $ocLazyLoad.load([
                    {
                        serie: true,
                        files: ['views/ops/syshostmap.js?v=' + version]
                    }]);
            }
        }
    }).state('infosys.sysinfotopology', {
        url: "infosys_sysinfotopology",
        data: {pageTitle: '系统拓扑'},
        templateUrl: "views/ops/systop.html?v=" + version,
        resolve: {
            loadPlugin: function ($ocLazyLoad) {
                return $ocLazyLoad.load([
                    {
                        serie: true,
                        files: ['views/ops/systop.js?v=' + version]
                    }]);
            }
        }
    })
